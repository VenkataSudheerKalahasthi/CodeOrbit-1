...
const AuthManager = {
    ...
    bindEvents() {
        ...
        this.setupPasswordToggle("toggle-auth-password", "auth-password");
        this.setupPasswordToggle("toggle-auth-confirm-password", "auth-confirm-password");
    ...
    setupPasswordToggle(toggleBtnId, inputId) {
        ...
        btn.addEventListener('click', (e) => {
            ...
            btn.innerHTML = isPassword ? eyeSlashSvg : eyeOpenSvg;
