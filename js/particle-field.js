...
(function () {
    ...
    function init() {
        ...
        /* ═══════════════════════════════════════════════════════
           SPATIAL COLOUR ZONES — Red & Crimson Dark Theme Palette
           Controlled red variations:
           Primary Red: #FF3B4F (1.00, 0.23, 0.31)
           Bright Red:  #FF4D5A (1.00, 0.30, 0.35)
           Deep Red:    #E11D48 (0.88, 0.11, 0.28)
           Crimson:     #BE123C (0.75, 0.07, 0.24)
           Soft Coral:  (0.95, 0.20, 0.30)
           ═══════════════════════════════════════════════════════ */
        var ZONE_PAL = [
            // Zone 0: Left (Crimson / Deep Red)
            [[32, 1.00, 0.23, 0.31], [28, 0.88, 0.11, 0.28], [20, 0.75, 0.07, 0.24],
             [12, 1.00, 0.30, 0.35], [ 8, 0.95, 0.20, 0.30]],
            // Zone 1: Right (Bright Red / Primary Red)
            [[30, 1.00, 0.30, 0.35], [26, 1.00, 0.23, 0.31], [20, 0.88, 0.11, 0.28],
             [14, 0.95, 0.20, 0.30], [10, 0.75, 0.07, 0.24]],
            // Zone 2: Top (Vibrant Red)
            [[30, 1.00, 0.23, 0.31], [24, 1.00, 0.30, 0.35], [20, 0.88, 0.11, 0.28],
             [16, 0.92, 0.15, 0.25], [10, 0.75, 0.07, 0.24]],
            // Zone 3: Bottom (Deep Crimson)
            [[28, 0.75, 0.07, 0.24], [24, 0.88, 0.11, 0.28], [20, 1.00, 0.23, 0.31],
             [16, 0.82, 0.08, 0.22], [12, 0.95, 0.18, 0.28]],
            // Zone 4: Centre (Balanced Red / Crimson Mix)
            [[18, 1.00, 0.23, 0.31], [16, 1.00, 0.30, 0.35], [14, 0.88, 0.11, 0.28],
             [12, 0.75, 0.07, 0.24], [10, 0.98, 0.18, 0.28], [ 8, 0.92, 0.15, 0.25],
             [ 8, 0.82, 0.08, 0.22], [ 8, 1.00, 0.26, 0.33], [ 6, 0.85, 0.10, 0.26]],
        ];
